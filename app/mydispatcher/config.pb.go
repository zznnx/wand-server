...
var file_config_proto_goTypes = []interface{}{
	(*SessionConfig)(nil), // 0: wand.app.mydispatcher.SessionConfig
	(*Config)(nil),        // 1: wand.app.mydispatcher.Config
}
var file_config_proto_depIdxs = []int32{
	0, // 0: wand.app.mydispatcher.Config.settings:type_name -> wand.app.mydispatcher.SessionConfig
